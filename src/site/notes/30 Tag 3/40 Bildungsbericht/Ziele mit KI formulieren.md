---
{"dg-publish":true,"permalink":"/30-tag-3/40-bildungsbericht/ziele-mit-ki-formulieren/"}
---
...
>Nachdem Sie in den vorherigen Modulen die Grundlagen der Zielformulierung (W-Fragen, SMART, 3-dimensional) kennengelernt und geübt haben, gehen wir nun einen Schritt weiter. In dieser Einheit erkunden Sie, wie Künstliche Intelligenz (KI) Sie als Berufsbildner/-in bei der Erstellung spezifischer Lernziele unterstützen kann.
...
>[!success]- Lernziele
>In dieser Einheit erweitern Sie Ihre Kompetenzen in der Lernzielformulierung durch den Einsatz von KI.
>**Das Ziel dieses Moduls ist, dass…**
>* …Sie den **Bildungsplan (BiPla) / die Bildungsverordnung (BiVo) Ihres Berufs** online finden und relevante **Handlungskompetenzen oder Leistungsziele im Betrieb** identifizieren können.
...
>>   - Notieren Sie sich die ausgewählte Kompetenzbeschreibung / das Leistungsziel.
>>   - Halten Sie folgende Informationen bereit, da der Chatbot diese zur Präzisierung der Lernziele benötigt (gemäss seiner Instruktion):
...
>>     *(Hier wird der Link zum Chatbot eingefügt oder die Anweisung, wie die Teilnehmenden darauf zugreifen)*
...
>[!faq]- Kurze Erinnerung: Was macht der Chatbot genau?
>Gemäss seiner Programmierung wird der Chatbot:
>* Zu Ihrer eingegebenen Kompetenzbeschreibung oder Ihrem Auftrag **sechs Lernziele** formulieren, die jeweils einer der **sechs Stufen der Bloom'schen Taxonomie** (Wissen, Verstehen, Anwenden, Analysieren, Bewerten, Erschaffen) entsprechen.
>* Darauf achten, dass die Ziele **allgemeinverständlich und handlungsorientiert** sind.
>* Die Ziele gegebenenfalls **visuell hervorheben** und mit **kurzen didaktischen Erläuterungen** versehen.
>* Zuerst Informationen zu **Beruf, Lehrjahr und Erfahrungsstand** erfragen, falls diese für die präzise Formulierung benötigt werden.
